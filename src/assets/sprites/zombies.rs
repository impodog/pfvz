...
pub struct SpriteZombies {
    ...
    pub gargantuar: Arc<sprite::FrameArr>,
    pub gargantuar_smash: Arc<sprite::FrameArr>,
    ...
    pub zomboss_head: Arc<sprite::FrameArr>,
    pub zomboss_body: Arc<sprite::FrameArr>,
    pub zomboss_arm: Arc<sprite::FrameArr>,
    pub zomboss_legs: Arc<sprite::FrameArr>,
}
...
pub(super) fn init_zombies(mut commands: Commands, server: Res<AssetServer>) {
    let zombies = SpriteZombies {
        ...
        gargantuar: super::load_animation(
            &server,
            "sprites/zombies/gargantuar",
            Duration::from_millis(500),
        ),
        gargantuar_smash: super::load_animation_then(
            &server,
            "sprites/zombies/gargantuar_smash",
            Duration::from_millis(300),
            |frames| frames.then_reverse(),
        ),
        bandaid: super::load_animation(
            &server,
            "sprites/zombies/bandaid",
            Duration::from_millis(100),
        ),
        imp: super::load_animation(&server, "sprites/zombies/imp", Duration::from_millis(300)),
        imp_dying: super::load_animation(
            &server,
        ...
        zomboss_head: super::load_animation(
            &server,
            "sprites/zombies/zomboss/head",
            Duration::from_millis(300),
        ),
        zomboss_body: super::load_animation(
            &server,
            "sprites/zombies/zomboss/body",
            Duration::from_millis(300),
        ),
        zomboss_arm: super::load_animation(
            &server,
            "sprites/zombies/zomboss/arm",
            Duration::from_millis(300),
        ),
        zomboss_legs: super::load_animation(
            &server,
            "sprites/zombies/zomboss/legs",
            Duration::from_millis(300),
        ),
    };
